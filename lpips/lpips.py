...
class LPIPS(nn.Module):
    def __init__(self, pretrained=True, net='alex', version='0.1', lpips=True, spatial=False, 
        ...
        # self.grad_cam=GradCam(model=self.net, blob_name = 'features', target_layer_names=['4','10'], use_cuda=False)
        if(lpips):
    ...
    def forward(self, in0, in1, retPerLayer=False, normalize=False):
        ...
        # in0_input
        # cam_extractor = SmoothGradCAMpp(self.net,input_shape=(c,h,w))
